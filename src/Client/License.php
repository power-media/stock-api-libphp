...
class License
{
     ...
     */
    protected function setDownloadUrl($url, $access_token = null)
    {
        if ($access_token) {
     ...
     */
    private function _validateParams(LicenseRequest $request, $access_token)
    {
     ...
     */
    public function getContentInfo(LicenseRequest $request, $access_token, HttpClientInterface $http_client)
    {
     ...
     * @return LicenseResponse contains LicenseEntitlement,LicensePurchaseOptions,LicenseMemberInfo,cce_agency and contents
     */
    public function getContentLicense(LicenseRequest $request, $access_token, HttpClientInterface $http_client)
    {
        $this->_validateParams($request, $access_token);
        if ($request->getLicenseState() === null) {
            throw StockApiException::withMessage('Licensing state must be present in the license request');
     ...
     * @return LicenseResponse contains LicenseEntitlement,LicensePurchaseOptions,LicenseMemberInfo,cce_agency and contents
     */
    public function getMemberProfile(LicenseRequest $request, $access_token, HttpClientInterface $http_client)
    {
        $this->_validateParams($request, $access_token);
     ...
     * @return int $code
     */
    public function abandonLicense(LicenseRequest $request, $access_token, HttpClientInterface $http_client)
    {
        $this->_validateParams($request, $access_token);
     ...
     */
    public function downloadAssetRequest(LicenseRequest $request, $access_token, HttpClientInterface $http_client)
    {
     ...
     */
    public function downloadAssetUrl(LicenseRequest $request, $access_token, HttpClientInterface $http_client)
    {
     ...
     */
    public function downloadAssetStream(LicenseRequest $request, $access_token, HttpClientInterface $http_client)
    {
        $guzzle_request = $this->downloadAssetRequest($request, $access_token, $http_client);
