...
class LicenseHistory
{
     ...
     */
    private function _doApiCall(LicenseHistoryRequest $request)
    {
     ...
     */
    private function _getFiles(LicenseHistoryRequest $license_file_request, $access_token = null)
    {
     ...
     */
    public function initializeLicenseHistory(LicenseHistoryRequest $request = null, $access_token = null, HttpClientInterface $http_client)
    {
        if ($request === null) {
