...
class SearchCategory
{
     ...
     */
    public function getCategory(SearchCategoryRequest $request, $access_token, HttpClientInterface $http_client)
    {
     ...
     */
    public function getCategoryTree(SearchCategoryRequest $request, $access_token, HttpClientInterface $http_client)
    {
        if ($request->getCategoryId() == null) {
            throw StockApiException::withMessage('Category Id cannot be null');
        }
     ...
     */
    private function _createSearchCategoryResponseArray(array $response_array)
    {
