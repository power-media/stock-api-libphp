...
class SearchFiles
{
     ...
     */
    private function _validateSearchParams(SearchFilesRequest $request, $access_token = null)
    {
     ...
     */
    public function getFiles(SearchFilesRequest $search_file_request, $access_token = null)
    {
     ...
     */
    public function doApiCall(SearchFilesRequest $request)
    {
    ...
    public function totalSearchPages()
    {
        if (!$this->_initial_invalid_state && $this->_current_response->getNbResults() != null) {
            return (int) ceil((double) $this->_current_response->getNbResults() / $this->_current_request->getSearchParams()->getLimit());
        }
    ...
    public function currentSearchPageIndex()
    {
        if (!$this->_initial_invalid_state && $this->_current_response->getNbResults() != null) {
            ...
            $result = (int) ceil((double) $offset_value / $this->_current_request->getSearchParams()->getLimit());
            return $result;
        }
        return SearchFiles::SEARCH_FILES_RETURN_ERROR;
    }
     ...
     * @return SearchFiles
     */
    public function searchFilesInitialize(SearchFilesRequest $request = null, $access_token = null, HttpClientInterface $http_client)
    {
        if ($request == null) {
     ...
     */
    private function _getHttpMethod(SearchFilesRequest $request)
    {
        $http_method = 'GET';
