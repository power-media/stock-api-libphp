...
final class StockApi extends \Exception
{
     ...
     * @return StockApi
     */
    public static function withMessage($message, \Exception $exception = null)
    {
     ...
     * @return StockApi
     */
    public static function withMessageAndErrorCode($message, $code, \Exception $exception = null)
    {
