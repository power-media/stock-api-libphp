...
class SearchParameters
{
     ...
     * @var array
     */
    protected $_json_mapper = ['filters_colors' => '[filters][colors]', 'filters_area_pixels' => '[filters][area_pixels]', 'filters_content_type_photos' => '[filters][content_type:photo]', 'filters_content_type_illustration' => '[filters][content_type:illustration]', 'filters_content_type_vector' => '[filters][content_type:vector]', 'filters_content_type_video' => '[filters][content_type:video]', 'filters_content_type_template' => '[filters][content_type:template]', 'filters_content_type_3d' => '[filters][content_type:3D]', 'filters_content_type_all' => '[filters][content_type:all]', 'filters_editorial' => '[filters][editorial]', 'filters_offensive_2' => '[filters][offensive:2]', 'filters_isolated_on' => '[filters][isolated:on]', 'filters_panoramic_on' => '[filters][panoramic:on]', 'filters_thumbnail_size' => '[filters][thumbnail_size]', 'filters_orientation' => '[filters][orientation]', 'filters_age' => '[filters][age]', 'filters_video_duration' => '[filters][video_duration]', 'filters_template_type_id' => '[filters][template_type_id][]', 'filters_3d_type_id' => '[filters][3d_type_id][]', 'filters_template_category_id' => '[filters][template_category_id][]', 'filters_premium' => '[filters][premium]', 'filters_has_releases' => '[filters][has_releases]'];
    /**
     ...
     */
    public function setSimilarURL($similar_url)
    {
     ...
     */
    public function setFilterColors($filters_colors)
    {
     ...
     */
    public function getFilterAreaPixels()
    {
     ...
     */
    public function setFilterAreaPixels($filters_area_pixels)
    {
     ...
     */
    public function getSimilarImage()
    {
     ...
     */
    public function setSimilarImage($similar_image)
    {
     ...
     */
    public function getFilterContentTypePhotos()
    {
     ...
     */
    public function setFilterContentTypePhotos($filters_content_type_photos)
    {
     ...
     */
    public function getFilterContentTypeIllustration()
    {
     ...
     */
    public function setFilterContentTypeIllustration($filters_content_type_illustration)
    {
     ...
     * @return bool|null whether ContentTypeVector filter is on or off
     */
    public function getFilterContentTypeVector()
    {
     ...
     */
    public function setFilterContentTypeVector($filters_content_type_vector)
    {
     ...
     */
    public function getFilterContentTypeVideo()
    {
     ...
     * @throws StockApiException if filterContentTypeVector is null
     */
    public function setFilterContentTypeVideo($filters_content_type_video)
    {
     ...
     * @return bool|null whether ContentTypeVideo filter is on or off
     */
    public function getFilterContentTypeTemplate()
    {
     ...
     */
    public function setFilterContentTypeTemplate($filters_content_type_template)
    {
     ...
     */
    public function getFilterContentType3D()
    {
     ...
     */
    public function setFilterContentType3D($filters_content_type_3d)
    {
     ...
     */
    public function getFilterContentTypeAll()
    {
     ...
     */
    public function setFilterContentTypeAll($filters_content_type_all)
    {
     ...
     */
    public function getFilterContentTypeEditorial()
    {
     ...
     * @throws StockApiException if filterContentTypeVector is null
     */
    public function setFilterContentTypeEditorial($filters_editorial)
    {
     ...
     */
    public function getFilterOffensive2()
    {
     ...
     */
    public function setFilterOffensive2($filters_offensive_2)
    {
     ...
     */
    public function getFilterIsolatedOn()
    {
     ...
     */
    public function setFilterIsolatedOn($filters_isolated_on)
    {
     ...
     */
    public function getFilterPanoromicOn()
    {
     ...
     * @throws StockApiException if IsolatedOn is null
     */
    public function setFilterPanoromicOn($filters_panoramic_on)
    {
     ...
     */
    public function setThumbnailSize($filters_thumbnail_size)
    {
     ...
     * @return SearchParameters object
     */
    public function setOrientation($filters_orientation)
    {
     ...
     * @return SearchParameters object
     */
    public function setFilterAge($filters_age)
    {
     ...
     */
    public function getFilterVideoDuration()
    {
     ...
     * @return SearchParameters object
     */
    public function setFilterVideoDuration($filters_video_duration)
    {
     ...
     */
    public function getFilterTemplateTypes()
    {
     ...
     */
    public function setFilterTemplateTypes(array $filters_template_type_id)
    {
     ...
     * @return array
     */
    public function getFilter3DTypeIds()
    {
     ...
     */
    public function setFilter3DTypeIds(array $filters_content_type_3d)
    {
     ...
     * @return array
     */
    public function getFilterTemplateCategoryIds()
    {
     ...
     * @return string|null
     */
    public function getFilterPremium()
    {
     ...
     * @return SearchParameters object
     */
    public function setFilterPremium($filters_premium)
    {
     ...
     * @return string|null
     */
    public function getFilterHasReleases()
    {
     ...
     */
    public function setFilterHasReleases($filters_has_releases)
    {
