...
class StockFileComps
{
     ...
     * @var array
     */
    public $json_mapper = ['Standard' => 'standard', 'Video_HD' => 'video_hd', 'Video_4K' => 'video_4k'];
    /**
     ...
     */
    public function setStandard(StockFileCompPropModels $standard)
    {
     ...
     * @return StockFileComps
     */
    public function setVideoHD(StockFileCompPropModels $video_hd)
    {
     ...
     * @return StockFileComps
     */
    public function setVideo4K(StockFileCompPropModels $video_4k)
    {
