...
class StockFileLicenses
{
     ...
     * @var array
     */
    public $json_mapper = ['Standard' => 'standard', 'Standard_M' => 'standard_m'];
    /**
     ...
     */
    public function setStandard(StockFileLicensePropModels $standard)
    {
     ...
     * @return StockFileLicenses
     */
    public function setStandardM(StockFileLicensePropModels $standard_m)
    {
