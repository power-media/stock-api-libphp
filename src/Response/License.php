...
class License
{
     ...
     * @return array|null
     */
    public function getLicenseReference()
    {
     ...
     * @return License
     */
    public function setEntitlement(LicenseEntitlement $val)
    {
     ...
     * @return License
     */
    public function setPurchaseOptions(LicensePurchaseOptions $val)
    {
     ...
     * @return License
     */
    public function setMemberInfo(LicenseMemberInfo $val)
    {
        $this->member = $val;
        return $this;
    }
     ...
     * @return License
     */
    public function setLicenseReference(array $val)
    {
        $this->cce_agency = $val;
        return $this;
    }
